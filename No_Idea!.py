...
# in the array, if [i into the set of [A],you add [1] to your happiness. If,
# [i into the set of B], you add [-1] to your happiness. Otherwise, your
...
# Explanation:
# You gain 1 unit of happiness for elements 3 and 1 in set [A]. You lose
# 1 unit for 5 in set [B]. The element 7 in set [B] does not exist in the
